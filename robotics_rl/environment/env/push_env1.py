...
class PushEnv1(BaxterEnv):

    def __init__(self, render, reward_type="shaped", control_type="position", range_coef=0.4, angle_coef=0.25):
    ...
    def _generate_target(self):
        self.targetPosition = []
        range = self.range_coef * (self.tableSize[0] / 2 - 0.2) + 0.2
        angle = self.angle_coef * 2 * np.pi
